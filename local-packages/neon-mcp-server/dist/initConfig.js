...
const commands = ['init', 'start', 'start:sse', 'export-tools'];
export const parseArgs = () => {
    ...
    if (args.length < 4) {
        logger.error('Please provide a NEON_API_KEY as a command-line argument - you can get one through the Neon console: https://neon.tech/docs/manage/api-keys');
        process.exit(1);
    }
    return {
...
export function handleInit({ executablePath, neonApiKey, analytics, }) {
