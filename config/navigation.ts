...
export const OS_LINKS = [
  { name: "Overview", href: "/overview", iconName: "LayoutDashboard" },
  { name: "Identity", href: "/identity", iconName: "User" },
  { name: "Ledger", href: "/ledger", iconName: "BookOpen" },
  { name: "Forecasting", href: "/forecasting", iconName: "Compass" },
  { name: "Records", href: "/records", iconName: "Calculator" },
  { name: "Career", href: "/career", iconName: "Briefcase" },
];
...
export const NAV_MATCH_PATTERNS: Record<string, RegExp> = {
  "/": /^\/$/,
  "/dashboard": /^\/dashboard(\/|$)/,
  "/overview": /^\/overview(\/|$)/,
  "/identity": /^\/identity(\/|$)/,
