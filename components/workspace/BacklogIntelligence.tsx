...
export function BacklogIntelligence() {
  ...
  return (
    <div className="w-full relative max-w-[1600px] mx-auto min-h-screen pb-32">
              ...
              >
                  ...
                  {isEditingGrade ? (
                    <div className="flex items-center gap-2 ml-2">
                      <input 
                        ...
                        className="w-16 bg-surface border border-white/[0.04] text-white rounded-lg px-2 py-1 text-sm font-bold focus:outline-none text-center uppercase"
                        placeholder="Grade"
                      />
                      <button 
                        onClick={() => {
                        ...
                        className="p-1.5 bg-[#34c759] text-black rounded-lg transition-colors"
                      >
                        <Check size={16} />
                      </button>
                      <button 
                        onClick={() => setIsEditingGrade(false)}
                        className="p-1.5 bg-[#f43f5e] text-white rounded-lg transition-colors"
                      >
                        <X size={16} />
                      </button>
                    </div>
                    ...
                    <button 
                      ...
                      className="ml-2 flex items-center gap-2 px-3 py-2 bg-surface hover:bg-[#2A2A2D] text-white rounded-xl transition-colors text-sm font-bold"
                ...
                <div className="flex gap-4 mb-6 border-b border-white/10 pb-4">
                  <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-colors ${activeTab === "ANALYTICS" ? "bg-white text-black" : "text-white/50 hover:text-white/80"}`}
                  >
                    <BarChart2 size={18} /> Analytics & ROI
                  </button>
                  <button 
                    onClick={() => setActiveTab("SIMULATIONS")}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-colors ${activeTab === "SIMULATIONS" ? "bg-white text-black" : "text-white/50 hover:text-white/80"}`}
                  >
                    <Compass size={18} /> Simulations
                  </button>
                  <button 
                    onClick={() => setActiveTab("ACTION_PLAN")}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-colors ${activeTab === "ACTION_PLAN" ? "bg-white text-black" : "text-white/50 hover:text-white/80"}`}
                  >
