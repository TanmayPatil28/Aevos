...
const MAIN_LINKS = [
  ...
  { name: 'Mission Control', href: '/productivity', icon: Target },
];
        ...
        <Link href="/" className="flex items-center gap-2 group outline-none">
          ...
          >
            <GraduationCap
              size={24}
              strokeWidth={2.5}
              className="z-10 drop-shadow-[0_0_15px_#4F8EF7]"
            />
            <motion.div
              initial={{ scale: 0 }}
              whileHover={{ scale: 1.5 }}
              className="absolute -z-10 w-full h-full bg-[#4F8EF7]/10 blur-xl rounded-full"
            />
          </motion.div>
          <span className="font-headline text-[20px] font-bold tracking-tight select-none">
            ...
            <span className="bg-gradient-to-r from-[#A855F7] via-[#7C3AED] to-[#A855F7] bg-[length:200%_auto] animate-gradient bg-clip-text text-transparent font-black">
              Flow
            </span>
          </span>
        </Link>
              ...
              <button
                ...
                className={cn(
                  ...
                  isToolsOpen || isAnyToolActive
                    ? 'text-white'
                    : 'text-white/60 hover:text-white group'
                )}
              >
                <Grip
                  size={17}
                  className={cn(
                    ...
                    isToolsOpen || isAnyToolActive
                      ? 'text-[#4F8EF7]'
                      : 'text-white/30 group-hover:text-[#4F8EF7]'
                  )}
                />
                <span>Tools</span>
                <motion.div
                    ...
                    <div className="space-y-1 mt-1">
                      {ADVANCED_TOOLS.map((tool) => (
                        ...
                        >
                          ...
                          <div>
                            <div className="text-[14px] font-black text-white/90 group-hover:text-white transition-colors tracking-tight">
                              {tool.name}
                            </div>
                            <div className="text-[12px] font-medium text-white/30 group-hover:text-white/50">
                              {tool.desc}
                            </div>
                          </div>
                          {pathname === tool.href && (
                            <motion.div
                              layoutId="tool-dot"
                              className="absolute right-4 w-1.5 h-1.5 bg-[#4F8EF7] rounded-full shadow-[0_0_10px_#4F8EF7]"
                            />
                          )}
                        </Link>
                      ))}
            ...
            >
              <School
                ...
                className={cn(
                  ...
                  isUniOpen ? 'text-white' : 'text-[#4F8EF7]'
                )}
              />
            ...
            <AnimatePresence>
              {isUniOpen && (
                ...
                >
                  ...
                  <div className="space-y-0.5 mt-1 max-h-[400px] overflow-y-auto custom-scrollbar pr-1">
                    {UNI_PRESETS.map((uni) => (
                      <button
                        key={uni.id}
                        onClick={() => {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {theme === 'dark' ? (
                  ...
                  <Sun size={18} strokeWidth={2.5} className="text-yellow-400" />
                )}
              </motion.div>
            </AnimatePresence>
          </button>
        ...
        {isMobileOpen && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-[#000]/80 backdrop-blur-[15px] z-[1002]"
            />
            <motion.div
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <span className="font-headline font-black text-2xl text-white tracking-widest">
                  GF.OS
                </span>
                <button
                  onClick={() => setIsMobileOpen(false)}
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                {ADVANCED_TOOLS.map((tool, i) => (
                  ...
                  >
                    <Link
                      href={tool.href}
                      className="flex items-center gap-4 p-4 rounded-2xl group active:bg-white/5"
                    >
                      <div
                        className={cn(
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-2.5 relative z-[2]"
      >
        <Icon
          size={18}
          ...
          className={cn(
            'transition-colors duration-500',
            isActive ? 'text-[#4F8EF7]' : 'text-white/30 group-hover:text-white/60'
          )}
        />
        <span
          className={cn(
