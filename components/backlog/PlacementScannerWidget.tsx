        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-[17px] font-semibold text-white flex items-center gap-2 tracking-tight">
              <Target className={isDanger ? "text-[#FF453A]" : "text-[#0A84FF]"} size={20} /> Placement Scanner
            </h3>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col justify-between">
          {isDanger ? (
            <div className="space-y-4">
              <div className="p-4 bg-[#FF453A]/10 rounded-2xl flex items-start gap-3">
                <AlertOctagon className="text-[#FF453A] shrink-0 mt-0.5" size={20} />
                <div>
                  <p className="text-[15px] text-[#FF453A] font-semibold tracking-tight">Auto-Disqualification Risk</p>
                  <p className="text-[13px] text-[#FF453A]/80 mt-1 leading-snug">The following backlogs violate the strict criteria of your pinned dream companies.</p>
                </div>
              </div>
              <ul className="space-y-3">
                {disqualifications.map(dis => (
                  <li key={dis.courseId} className="bg-[#2C2C2E] p-4 rounded-2xl">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-[15px] text-white font-bold">{dis.courseCode}</span>
                      <span className="text-[11px] uppercase tracking-wider font-bold bg-[#FF453A]/20 text-[#FF453A] px-2.5 py-1 rounded-full">Critical</span>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center text-center py-4">
              <div className="p-4 bg-[#30D158]/10 rounded-full mb-4">
                <CheckCircle2 className="text-[#30D158]" size={32} />
              </div>
          ...
          <button 
            ...
            className="w-full mt-4 py-3 rounded-xl bg-[#2C2C2E] text-white font-semibold text-[15px] hover:bg-[#3A3A3C] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
          ...
          <div className="bg-[#2C2C2E] p-4 rounded-2xl">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
                <Briefcase className="text-[#FF453A]" size={20} />
              </div>
              <div>
