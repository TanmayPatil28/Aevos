        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-[17px] font-bold text-white flex items-center gap-2 tracking-wide">
              <PlaySquare className="text-status-critical" size={20} /> Smart Resources
            </h3>
        ...
        <div className="flex-1 space-y-3 overflow-y-auto no-scrollbar">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-status-critical text-white flex items-center justify-center">
                  <PlayCircle size={20} />
                </div>
                <div>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-status-warning text-black flex items-center justify-center">
                  <FileText size={18} />
                </div>
                <div>
      ...
      >
        <div className="space-y-4 pb-6">
          <div className="w-full aspect-video bg-black rounded-2xl border border-white/10 flex flex-col items-center justify-center relative overflow-hidden group cursor-pointer">
            ...
            />
            <div className="w-16 h-16 bg-status-critical rounded-full flex items-center justify-center text-white z-10 shadow-none group-hover:scale-110 transition-transform">
          ...
          <div className="space-y-2 mt-4">
            <div className="p-3 bg-surface rounded-xl flex items-center gap-3 border border-status-critical">
              <div className="w-2 h-2 rounded-full bg-status-critical" />
              <p className="text-[15px] text-white">Up Next: Complex Variables (15:20)</p>
            </div>
            <div className="p-3 bg-surface rounded-xl flex items-center gap-3 border border-white/[0.04]">
