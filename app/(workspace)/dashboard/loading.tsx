...
export default function DashboardLoading() {
  return (
    <div className="flex flex-col w-full min-h-[100dvh] bg-[var(--aevos-background)] text-[var(--aevos-text-primary)] overflow-hidden relative aevos-texture font-sans p-8 gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-[var(--aevos-surface)] border border-slate-800 p-6 rounded-xl animate-pulse">
          ...
          <div className="bg-[var(--aevos-surface)] border border-slate-800 p-6 rounded-xl space-y-4">
        ...
        <div className="lg:col-span-1">
          <div className="bg-[var(--aevos-surface)] border border-slate-800 p-6 rounded-xl h-[500px] flex flex-col items-center justify-center animate-pulse">
